...
export const REGISTER_FORM_SUBMIT = 'REGISTER_REGISTER_FORM_SUBMIT';
export const REGISTER_FORM_SUCCESS = 'REGISTER_REGISTER_FORM_SUCCESS';
export const REGISTER_FORM_FAILED = 'REGISTER_REGISTER_FORM_FAILED';
